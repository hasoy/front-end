...
function ContactPage() {
  ...
  const FAQ = [
    {
      title: LABELS.CONTACT.WIE_ZIJN_WIJ.TITLE,
      desc: LABELS.CONTACT.WIE_ZIJN_WIJ.DESC,
    },
    {
      title: LABELS.CONTACT.MISSIE_EN_VISIE.TITLE,
      desc: LABELS.CONTACT.MISSIE_EN_VISIE.DESC,
    },
    {
      title: LABELS.CONTACT.MADHAHIB.TITLE,
      desc: LABELS.CONTACT.MADHAHIB.DESC,
    },
    { title: LABELS.CONTACT.CONTACT.TITLE, desc: LABELS.CONTACT.CONTACT.DESC },
    {
      title: LABELS.CONTACT.SUPPORTED_STORES.TITLE,
      desc: LABELS.CONTACT.SUPPORTED_STORES.DESC,
    },
  ];
